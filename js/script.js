document.addEventListener("DOMContentLoaded", function () {
  ...
  if (sliderImage && caption && nextBtn && prevBtn) {
    ...
    const slides = [
      { image: "assets/img1.jpg", caption: "Every smile with you feels magical 💖" },
      { image: "assets/img2.jpg", caption: "The moment our story took a beautiful turn ✨" },
      { image: "assets/img3.jpg", caption: "Memories I want to relive forever 💕" },
      { image: "assets/img4.jpg", caption: "Love is composed of a single soul inhabiting two bodies ❤️" },
      { image: "assets/img5.jpg", caption: "You are my favorite part of every day ❤️" },
      { image: "assets/img6.jpg", caption: "In a sky full of stars, your name is still my wish. 🌌" },
      { image: "assets/img7.jpg", caption: "Love like ours doesn’t need confetti — just presence. ❤️" }
    ];
